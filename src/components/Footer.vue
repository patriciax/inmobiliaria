    ...
    <div class="container pt-lg-4 pb-4">
      ...
      <div class="row mb-5 pb-md-3 pb-lg-4">
        <div class="col-lg-6 mb-lg-0 mb-4">
          <div class="d-flex flex-sm-row flex-column justify-content-between mx-n2">
            <div class="mb-sm-0 mb-4 px-2">
              <router-link class="d-inline-block mb-4" to="/real-estate-home-v1">
                <img src="@/assets/img/logo/logo-dark.svg" width="116" alt="logo" />
              </router-link>
              <ul class="nav flex-column mb-sm-4 mb-2">
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="mailto:example@email.com">
                    <i class="fi-mail mt-n1 me-2 align-middle opacity-70"></i>example@email.com</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link p-0 fw-normal" href="tel:4065550120">
                    <i class="fi-device-mobile mt-n1 me-2 align-middle opacity-70"></i>(406)
                    555-0120</a>
                </li>
              </ul>
              <div class="pt-2">
            ...
            <div class="mb-sm-0 mb-4 px-2">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Buy a property</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Sell a property</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Rent a property</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Сalculate your property</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Top offers</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Top cities</a>
                </li>
              </ul>
            </div>
            <div class="px-2">
              ...
              <ul class="nav flex-column">
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">About Us</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Our agents</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Help &amp; support</a>
                </li>
                <li class="nav-item mb-2">
                  <a class="nav-link p-0 fw-normal" href="javascript:void(0);">Contacts</a>
                </li>
                <li class="nav-item mb-2"><a class="nav-link p-0 fw-normal" href="javascript:void(0);">News</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-xl-5 col-lg-6 offset-xl-1">
          ...
          <article class="d-flex align-items-start" style="max-width: 640px">
            <router-link class="d-none d-sm-block flex-shrink-0 me-sm-4 mb-sm-0 mb-3" to="/real-estate-blog-single">
              <img class="rounded-3" src="@/assets/img/real-estate/blog/th01.jpg" width="100" alt="Blog post" /></router-link>
            <div>
              <h6 class="mb-1 fs-xs fw-normal text-uppercase text-primary">Home improvement</h6>
              <h5 class="mb-2 fs-base">
                <router-link class="nav-link" to="/real-estate-blog-single">Your Guide to a Smart Apartment Searching</router-link>
              </h5>
              <p class="mb-2 fs-sm">
              ...
              <a class="nav-link nav-link-muted d-inline-block me-3 p-0 fs-xs fw-normal" href="javascript:void(0);">
                <i class="fi-chat-circle mt-n1 me-1 fs-sm align-middle opacity-70"></i>2comments</a>
            </div>
          </article>
          <hr class="text-dark opacity-10 my-4" />
          <article class="d-flex align-items-start" style="max-width: 640px">
            <router-link class="d-none d-sm-block flex-shrink-0 me-sm-4 mb-sm-0 mb-3" to="/real-estate-blog-single">
              <img class="rounded-3" src="@/assets/img/real-estate/blog/th02.jpg" width="100" alt="Blog post" />
            </router-link>
            <div>
              <h6 class="mb-1 fs-xs fw-normal text-uppercase text-primary">Tips &amp; advice</h6>
              <h5 class="mb-2 fs-base">
                <router-link class="nav-link" to="/real-estate-blog-single">Top 10 Ways to Refresh Your Space</router-link>
              </h5>
              <p class="mb-2 fs-sm">
      ...
      <div class="bg-dark rounded-3">
        <div class="col-xxl-10 col-md-11 col-10 d-flex flex-md-row flex-column-reverse align-items-md-end align-items-center mx-auto px-0">
          <img class="flex-shrink-0 mt-md-n5 me-md-5" src="@/assets/img/real-estate/illustrations/mobile.svg" width="240" alt="Finder mobile app" />
          <div class="align-self-center d-flex flex-lg-row flex-column align-items-lg-center pt-md-3 pt-5 ps-xxl-4 text-md-start text-center">
            ...
            <div class="flex-shrink-0">
              <a class="btn-market mx-2 ms-sm-0 me-sm-4 mb-3" href="javascript:void(0);" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="132" height="34" fill="#fff">
                ...
                </svg></a><a class="btn-market mb-3" href="javascript:void(0);" role="button"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="140" height="34" fill="none">
                  <g fill="#fff">
      ...
      <div class="text-center fs-sm pt-4 mt-3 pb-2">
        ...
        <a href="#!" class="d-inline-block nav-link p-0" rel="noopener">SRBThemes</a>
      </div>
    </div>
  </footer>
</template>
