...
import lottieJson from '@/assets/json/animation-real-estate-404.json'
</script>
...
<template>
  ...
  <section class="d-flex align-items-lg-center align-items-end position-relative min-vh-100 py-lg-5 py-0">
    <!-- Bg overlay-->
    <span class="position-absolute top-0 start-0 d-lg-block d-none w-100 h-100 zindex-1 bg-dark rounded-4 rounded-start-0" style="max-width: 43.6vw;"></span>
    <!-- Overlay content-->
    <div class="container position-relative zindex-5">
      <div class="row align-items-md-center gy-4">
        <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-start text-center">
          <!-- Bg overlay (mobile)-->
          <span class="position-absolute top-0 start-0 d-lg-none d-block w-100 h-100 zindex-1 bg-dark rounded-bottom-0 rounded-4"></span>
          <!-- Overlay content-->
          <div class="position-relative zindex-5">
            <h1 class="display-3 text-light">Page Not Found.</h1>
            <p class="mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70">Sorry, we can’t find the page you are looking for. We suggest you go to homepage while we are fixing the problem.</p>
            ...
            <div class="pt-3">
              <router-view class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" to="/">Go to homepage</router-view>
              <router-view class="btn btn-lg btn-outline-light w-sm-auto w-100 mb-3" to="/real-estate-help-center">Visit help center</router-view>
            </div>
          </div>
        </div>
        <div class="col-lg-6 offset-lg-2 order-lg-2 order-1">
          <div class="ratio ratio-1x1 mx-auto" style="max-width: 636px;">
            <Vue3Lottie :animationData="lottieJson" />
          </div>
        </div>
      </div>
    </div>
