        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade show active" id="for-rent" role="tabpanel">
            <div class="row g-4 g-md-3 g-lg-4 pt-2">
              <!-- Item-->
              <div
                v-for="(property, index) in propertyRentData"
                :key="index"
                ...
                <div v-if="index < 9" class="card shadow-sm card-hover border-0 h-100">
                  ...
                  <div class="card-body position-relative pb-3">
                    ...
                    <h3 class="h6 mb-2 fs-base">
                      <router-link class="nav-link stretched-link" to="/real-estate-single-v1">{{
                        property.title
                      }}</router-link>
                    </h3>
                  ...
                  >
                    <span class="d-inline-block mx-1 px-2 fs-sm"
                      >{{ property.beds }}<i class="fi-bed ms-1 mt-n1 fs-lg text-muted"></i
                    ></span>
                    <span class="d-inline-block mx-1 px-2 fs-sm"
                      >{{ property.baths }}<i class="fi-bath ms-1 mt-n1 fs-lg text-muted"></i
                    ></span>
                    <span class="d-inline-block mx-1 px-2 fs-sm"
                      >{{ property.cars }}<i class="fi-car ms-1 mt-n1 fs-lg text-muted"></i
                    ></span>
                  </div>
                </div>
              </div>
            ...
            <div class="text-center mt-1 pt-4">
              <a
                class="d-inline-block fw-bold text-decoration-none p-2 pb-0"
                href="javascript:void(0);"
                ><i class="fi-refresh fs-sm me-2"></i>Load more</a
              >
            </div>
          </div>
          <!-- For sale tab-->
          <div class="tab-pane fade" id="for-sale" role="tabpanel">
            <div class="row g-4 g-md-3 g-lg-4 py-2">
              <!-- Item-->
              <div
                v-for="(property, index) in propertySaleData"
                :key="index"
                class="col-sm-6 col-xl-4"
              >
