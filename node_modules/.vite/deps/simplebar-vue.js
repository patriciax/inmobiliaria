...
// node_modules/simplebar-vue/node_modules/vue-demi/lib/index.mjs
var isVue3 = true;
...
var _a;
function renderFn(_a2) {
  var _b;
  var h2 = _a2.h, emit = _a2.emit, slots = _a2.slots, props = _a2.props;
  var onScroll = function(event) {
    return emit("scroll", event);
  };
  var classNames = __assign2(__assign2({}, SimpleBarCore.defaultOptions.classNames), props.classNames);
  return h2("div", __assign2({ ref: "element" }, isVue3 ? {
    "data-simplebar": "init"
  } : {
    attrs: {
      "data-simplebar": "init"
    ...
    h2("div", {
      ...
      h2("div", { "class": classNames.heightAutoObserverWrapperEl }, [
        h2("div", { "class": classNames.heightAutoObserverEl })
      ]),
      h2("div", { "class": classNames.mask }, [
        h2("div", { "class": classNames.offset }, [
          h2("div", __assign2(__assign2({}, isVue3 ? {
            onScroll,
            ...
            h2("div", { "class": classNames.contentEl, ref: "contentElement" }, (_b = slots["default"]) === null || _b === void 0 ? void 0 : _b.call(slots))
          ])
        ])
      ]),
      h2("div", { "class": classNames.placeholder })
    ]),
    h2("div", { "class": "".concat(classNames.track, " simplebar-horizontal") }, [
      h2("div", { "class": classNames.scrollbar })
    ]),
    h2("div", { "class": "".concat(classNames.track, " simplebar-vertical") }, [
      h2("div", { "class": classNames.scrollbar })
    ])
  ]);
}
var simplebar = defineComponent((_a = {
  ...
  mounted: function() {
    ...
    for (var _i = 0, _a2 = Object.entries(this.$props); _i < _a2.length; _i++) {
  ...
  var _a2;
  (_a2 = this.SimpleBar) === null || _a2 === void 0 ? void 0 : _a2.unMount();
  this.SimpleBar = void 0;
}, _a.methods = {
  recalculate: function() {
    var _a2;
    (_a2 = this.SimpleBar) === null || _a2 === void 0 ? void 0 : _a2.recalculate();
  }
}, /**
