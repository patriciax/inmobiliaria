...
var createAnimator = (definition, category, property) => {
  ...
  const props2 = typeof def === "object" ? { ...def } : {};
  return animator[type] ? animator[type](props2) : null;
};
var addGetSet = (keys, obj, props2, overwrite = false) => {
...
var createRoute = (routes, fn2) => ({ root: root2, props: props2, actions: actions2 = [], timestamp, shouldOptimize }) => {
...
var create = ({ root: root2, props: props2 }) => {
  props2.spin = false;
  props2.progress = 0;
  props2.opacity = 0;
...
var write = ({ root: root2, props: props2 }) => {
  if (props2.opacity === 0) {
    return;
  }
  if (props2.align) {
...
var create$2 = ({ root: root2, props: props2 }) => {
...
var updateFile = ({ root: root2, props: props2 }) => {
  text(
    root2.ref.fileSize,
    toNaturalFileSize(
...
var updateFileSizeOnError = ({ root: root2, props: props2 }) => {
...
var create$4 = ({ root: root2, props: props2 }) => {
...
var write$2 = ({ root: root2, actions: actions2, props: props2 }) => {
...
var create$5 = ({ root: root2, props: props2 }) => {
...
var didLoadItem = ({ root: root2, props: props2 }) => {
  text(root2.ref.fileName, formatFilename(root2.query("GET_ITEM_NAME", props2.id)));
};
...
var create$6 = ({ root: root2, props: props2 }) => {
  [
    {
      name: "top"
    },
...
var write$3 = ({ root: root2, props: props2 }) => {
  if (root2.ref.scalable === null || props2.scalable !== root2.ref.scalable) {
    root2.ref.scalable = isBoolean(props2.scalable) ? props2.scalable : true;
...
var create$7 = ({ root: root2, props: props2 }) => {
...
var write$5 = ({ root: root2, props: props2, actions: actions2, shouldOptimize }) => {
...
var clearDragCoordinates = ({ props: props2 }) => {
  props2.dragCoordinates = null;
};
...
var write$6 = ({ root: root2, props: props2, actions: actions2 }) => {
...
var create$a = ({ root: root2, props: props2 }) => {
...
var create$b = ({ root: root2, props: props2 }) => {
...
var write$7 = ({ root: root2, props: props2, actions: actions2 }) => {
...
var create$d = ({ root: root2, props: props2 }) => {
...
var create$e = ({ root: root2, props: props2 }) => {
...
var write$9 = ({ root: root2, props: props2, actions: actions2 }) => {
